...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/Zefanrakh/kue-preorder/api/gen/go/kuepreorder/identity/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	IdentityServiceName = "kuepreorder.identity.v1.IdentityService"
)
...
const (
	...
	IdentityServiceWhoAmIProcedure = "/kuepreorder.identity.v1.IdentityService/WhoAmI"
)

// IdentityServiceClient is a client for the kuepreorder.identity.v1.IdentityService service.
...
// NewIdentityServiceClient constructs a client for the kuepreorder.identity.v1.IdentityService
...
func NewIdentityServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IdentityServiceClient {
	...
	identityServiceMethods := v1.File_kuepreorder_identity_v1_identity_proto.Services().ByName("IdentityService").Methods()
...
// WhoAmI calls kuepreorder.identity.v1.IdentityService.WhoAmI.
...
// IdentityServiceHandler is an implementation of the kuepreorder.identity.v1.IdentityService
// service.
...
func NewIdentityServiceHandler(svc IdentityServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/kuepreorder.identity.v1.IdentityService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIdentityServiceHandler) WhoAmI(context.Context, *connect.Request[v1.WhoAmIRequest]) (*connect.Response[v1.WhoAmIResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("kuepreorder.identity.v1.IdentityService.WhoAmI is not implemented"))
}
